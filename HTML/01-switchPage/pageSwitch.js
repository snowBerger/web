(function($) {
        ...
        PageSwitch.prototype = {
            ...
            _scrollPage: function() {
                ...
                if (_prefix) {
                    ...
                    me.sections.animate(animatesCss, me.settings.direction, function() {
                        me.canScroll = true;
                        if (me.settings.callback && $.type(me.settings.callback) == "function") {
                            me.settings.callback();
                        }
    ...
    $.fn.PageSwitch.default = {
        ...
        direction: "vertical", //滑动方向：vertical、herizontal
        callback: ""
    }
